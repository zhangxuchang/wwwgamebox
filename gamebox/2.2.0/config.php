...
$CONFIG['GamesData']['lortr'] = array(
    ...
    'url'           => '//odp3.oasgames.com/api/game/serverlist?source=client&gamecode=lortr&uid={uid}',
    'openGamesFlag' => 1,  //控制是否启用游戏中心页面或者直接打开游戏  1 -> 打开游戏  0 -> 打开游戏中心
    'login_css'     => $CONFIG['cdn'] . 'static/css/oas.login.css',
    'login_skin'    => '2',
    'getNewsUrl'    => '//odp3.oasgames.com/api/game/gbox-news?source=client&gamecode=lortr'
);
